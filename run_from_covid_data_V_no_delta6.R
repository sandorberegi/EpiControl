...
policy_labels <- c("1" = "No restrictions", "2" = "SD1", "4" = "SD3", "5" = "SD4", "6" = "Lockdown")
...
ggplot(combined_data %>% filter(sim_id == 1)) +
  ...
  scale_color_manual(values = c("SD1" = "aquamarine", "SD3" = "deeppink", "SD4" = "darkorchid1", "No restrictions" = "chartreuse3", "Lockdown" = "red")) +
  guides(color = guide_legend(title = "Policy"))
...
#write.csv(combined_data, "covid_V_no_delta6.csv", row.names = FALSE)
