...
column_names <- c("days", "sim_id", "I", "Lambda", "C", "Lambda_C", "S", "Deaths", "Re", "Rew", "Rest", "R0est", "policy", "R_coeff", "p", "n", "o", "pp")
...
episim_data[1,] <- c(1, 1, I0, I0, Noise_pars['ur_mean']*I0, Noise_pars['ur_mean']*I0, N-I0, 0, Epi_pars[1,'R0'], Epi_pars[1,'R0'], 1, 1, 1, 1, 0, 0, 1)
...
ggplot(combined_data %>% filter(sim_id == 1)) +
  ...
  geom_line(aes(x = days, y = 5000*pp, color = factor(policy, labels = policy_labels), group = 1), alpha = 1.0, size=0.25) +
