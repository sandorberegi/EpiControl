...
results <- pblapply(1:sim_ens, function(idx) {
  Epi_MPC_run_wd(episim_data_ens[[idx]], Epi_pars, Noise_pars, Action_space, pred_days = 28, n_ens = 100, start_day = 1, ndays = ndays, R_est_wind = 5, pathogen = 1, susceptibles = 0, delay = 0, ur = 0, r_dir = 0, N = N)
}, cl = cl)
