---
title: "COVID-19 Vaccination and new variant"
...
Define parameters for pathogens and noise: Can include different pathogens, in this case we consider COVID-19 and Ebola virus disease.
...
Define non-pharmaceutical interventions: We have 3 actions, "lockdown", "social-distancing", and no interventions.
...
Set up key parameters and initialise simulation data. We use COVID-19 cases from the UK to intialise our simulations and turn our controller on on 1 January 2021 to bring cases near the target 5000 cases/day. We model the rollout of a vaccination programme and simulate the emergence of a 75% percent more transmissible variant (to relicate the emergence of the delta variant in the UK) which also reduces vaccine efficacy from 83% to 71.5%

```{r simulation-setup}
ndays <- real_days+61L*7L #simulation length
...
R_est_wind <- 5  # Define window size
