---
title: "COVID-19 control with a larger NPI space"
...
cat("## Overview\n\n",
    "This vignette demonstrates model predictive optimal control of COVID-19 cases with a larger NPI space \n\n")
```
...
Define an action space with 10 actions:
...
The target is to keep cases around 5000 cases/day.
